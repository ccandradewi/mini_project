...
CREATE TABLE `events` (
  ...
  `promotor` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `createdAt` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updatedAt` datetime(3) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `events_title_idx` (`title`),
  KEY `events_user_id_fkey` (`user_id`),
  KEY `events_location_id_fkey` (`location_id`),
  ...
  CONSTRAINT `events_location_id_fkey` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `locations` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `location` enum('JABODETABEK','JAWA','SUMATRA','KALIMANTAN','SULAWESI','BALI_NUSA_TENGGARA','PAPUA_MALUKU') COLLATE utf8mb4_unicode_ci NOT NULL,
  `createdAt` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updatedAt` datetime(3) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dump completed on 2024-05-22 14:27:27
