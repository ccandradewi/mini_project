    ...
    <>
      <div className="">
        <div className="flex flex-row gap-4 justify-center">
          <div className="">
            <div className="flex flex-col gap-4 justify center items-center  border rounded-xl h-96 w-[500px]">
              <div className="py-4">
                <img
                  className="h-36"
              ...
              <div className="text-center text-black px-8">
                ...
                join us for what promises to be an unforgettable experience.
                Your order has been successfully processed, and your Tickets are
                confirmed.
              </div>
            </div>
          </div>
          ...
          {orders &&
            orders.map((order, index) => (
              <div key={index} className="flex flex-col gap-4 ">
                    ...
                    <div className="flex-col flex gap-2 justify-center">
                      ...
                      <div>
                        ...
                        <div className="flex flex-row items-center gap-2">
                          <IoCalendarOutline />{" "}
                          {dayjs(order?.event?.start_time).format(
                            "DD MMMM YYYY"
                          )}
                        </div>
                        <div className="flex flex-row items-center gap-2">
                ...
                {/* user data */}
                <div className="flex-col flex border rounded-xl justify-center px-8 py-4 gap-2">
                  <div className="font-semibold text-xl"> Buyer Detail</div>
                  <div className="flex flex-row gap-2">
                    Name:
                ...
                <div className=" flex flex-col gap-2 p-4 border-1 rounded-xl justify-center">
                  <div className="font-semibold text-xl">Payment Detail</div>
                  <div className="flex flex-row justify-between">
                    <div>Invoice:</div>
